    ...
    fn try_from(value: raw::XvdHeader) -> Result<Self, Self::Error> {
        Ok(Self {
            ...
            package_version: Version {
                major: value.package_version1.get(),
                minor: value.package_version2.get(),
                patch: value.package_version3.get(),
                build: value.package_version4.get(),
            },
            ...
            required_system_version: Version {
                major: value.required_system_version1.get(),
                minor: value.required_system_version2.get(),
                patch: value.required_system_version3.get(),
                build: value.required_system_version4.get(),
            },
